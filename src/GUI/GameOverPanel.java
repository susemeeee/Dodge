...
public class GameOverPanel extends JPanel {
	...
	private JButton rouletteButton = new JButton("�� ��");
	private JLabel rouletteInfoLabel = new JLabel("1ȸ ������ ��������");
	private int rouletteCount = 0;
	private JLabel remainingCountLabel = new JLabel(Integer.toString(MAX_ROULETTE - rouletteCount) + " ȸ ����");
		...
		rouletteButton.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				if(rouletteCount < MAX_ROULETTE) {
					...
					remainingCountLabel.setText(Integer.toString(MAX_ROULETTE - rouletteCount) + " ȸ ����");
	...
	private void setDefaultPanel(GameCharacter gameCharacter) {
		...
		gameOverLabel.setFont(new Font("�ü�ü", Font.BOLD, 36));
		
		scoreTitleLabel.setSize(300, 70);
		scoreTitleLabel.setLocation(270, 250);
		scoreTitleLabel.setFont(new Font("�ü�ü", Font.BOLD, 24));
		
		scoreLabel.setText(Integer.toString(gameCharacter.getCurrentScore()));
		scoreLabel.setSize(200, 70);
		scoreLabel.setLocation(320, 250);
		scoreLabel.setFont(new Font("�ü�ü", Font.PLAIN, 24));
