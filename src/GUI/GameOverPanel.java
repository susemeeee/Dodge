...
public class GameOverPanel extends JPanel {
	...
	private JLabel remainingCountLabel = new JLabel(Integer.toString(MAX_ROULETTE - rouletteCount) + " È¸ ï¿½ï¿½ï¿½ï¿½");
		...
		rouletteButton.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				if(rouletteCount < MAX_ROULETTE) {
					...
					remainingCountLabel.setText(Integer.toString(MAX_ROULETTE - rouletteCount) + " È¸ ï¿½ï¿½ï¿½ï¿½");
	...
	private void setDefaultPanel(GameCharacter gameCharacter) {
		...
		gameOverLabel.setFont(new Font("ï¿½Ã¼ï¿½Ã¼", Font.BOLD, 36));
		
		scoreTitleLabel.setSize(300, 70);
		scoreTitleLabel.setLocation(270, 250);
		scoreTitleLabel.setFont(new Font("ï¿½Ã¼ï¿½Ã¼", Font.BOLD, 24));
		
		scoreLabel.setText(Integer.toString(gameCharacter.getCurrentScore()));
		scoreLabel.setSize(200, 70);
		scoreLabel.setLocation(320, 250);
		scoreLabel.setFont(new Font("ï¿½Ã¼ï¿½Ã¼", Font.PLAIN, 24));
